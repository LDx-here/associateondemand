...
const AOS_DISCRETIONARY_BRIEF_FIELDS: FactFieldDef[] = [
  ...
  },
  {
    ...
    feedsSection: "Qualifying relative / extreme hardship",
    kind: "text",
    required: true,
  },
  {
  ...
  },
  {
    ...
    feedsSection: "Inadmissibility & waiver eligibility",
    kind: "textarea",
    required: true,
  },
  {
    ...
    feedsSection: "Negative discretionary factors / 212(h) analysis",
    kind: "textarea",
    required: true,
  },
  {
  ...
  },
  {
    ...
    feedsSection: "Prior immigration history / procedural posture",
    kind: "textarea",
  },
];
