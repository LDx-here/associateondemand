...
const AOS_DISCRETIONARY_BRIEF_FIELDS: FactFieldDef[] = [
  {
    id: "clientStatus",
    label: "Current immigration status",
    hint: "e.g. out of status, TPS, visa overstay, lawful permanent resident",
    feedsSection: "CREAC Analysis — client background",
    kind: "text",
    required: true,
  },
  {
    ...
    hint: "e.g. AOS under INA §245 with I-601A waiver of inadmissibility",
    feedsSection: "CREAC Conclusion — relief requested",
    kind: "text",
    required: true,
  },
  {
    id: "qualifyingRelative",
    label: "Qualifying relative and relationship",
    hint: "U.S. citizen or LPR spouse, parent, etc. — name and relationship",
    feedsSection: "CREAC Analysis — qualifying relative / hardship",
    kind: "text",
    required: true,
  },
  {
    id: "extremeHardshipFactors",
    label: "Extreme hardship factors to the qualifying relative",
    hint: "Medical, financial, psychological, country conditions, family ties abroad",
    feedsSection: "CREAC Analysis — extreme hardship",
    kind: "textarea",
    required: true,
  },
  {
    id: "inadmissibilityGrounds",
    label: "Grounds of inadmissibility (INA §212(a))",
    hint: "e.g. unlawful presence, fraud, criminal grounds — cite subsection if known",
    feedsSection: "CREAC Analysis — inadmissibility & waiver",
    kind: "textarea",
    required: true,
  },
  {
    id: "adverseFactors",
    label: "Negative discretionary factors",
    hint: "Criminal history, prior denials, unlawful presence, misrepresentation — or “none known”",
    feedsSection: "CREAC Analysis — negative factors",
    kind: "textarea",
    required: true,
  },
  {
    ...
    hint: "Family ties in U.S., community service, rehabilitation, length of residence, employment",
    feedsSection: "CREAC Analysis — positive equities",
    kind: "textarea",
    required: true,
  },
  {
    id: "priorFilings",
    label: "Prior immigration history relevant to waiver context",
    hint: "Prior AOS, visa applications, removal proceedings, voluntary departure — with outcomes",
    feedsSection: "CREAC Analysis — prior history / posture",
    kind: "textarea",
  },
];
