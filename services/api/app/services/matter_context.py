...
_IMMIGRATION_FIELD_LABELS = (
    ...
    ("entryVisaType", "Visa type at entry"),
    ("petitionerName", "Petitioner name"),
    ("petitionerRelationship", "Petitioner relationship"),
    ("i130ApprovedDate", "I-130 approval date"),
    ("i485FiledDate", "I-485 filing date"),
    ("caseTheme", "Case theme (attorney-authored)"),
    ("caseThemeBrief", "Case theme (brief restatement)"),
    ("sectionAHeading", "Section A heading (argument claim)"),
    ("sectionAFacts", "Section A facts"),
    ("sectionBHeading", "Section B heading (argument claim)"),
    ("sectionBFacts", "Section B facts"),
    ("adverseHeading", "Adverse section heading"),
    ("adverseFacts", "Adverse facts with context"),
    ("adverseFactorBrief", "Adverse factor (one phrase)"),
    ("balancingInventory", "Balancing inventory"),
    ("departureHarm", "Harm if applicant departed"),
    ("positiveEquities", "Positive equities"),
