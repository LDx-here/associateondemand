...
1. **One attorney action batch (optional before pilot):** set Stripe + Resend env vars on Vercel — see gap table above and `bash scripts/stripe-setup-checklist.sh`.
