...
import { Phone, ArrowRight, CheckCircle, Scale, Shield, Globe } from "lucide-react";
        ...
        <div className="container">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-secondary/50 rounded-lg p-8 border border-border">
              <p className="text-sm text-muted-foreground italic mb-4">Of Counsel — Paulozzi, Alkire, Condeni Personal Injury Lawyers</p>
      ...
      <section className="py-20 bg-secondary/30">
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[{icon: Scale, title: "Property Damage", description: "Diminished value, total loss disputes, loss of use, and underpayment claims. We bring order and strategy to complex insurance disputes so you can move forward.", href: "/property-damage"}, {icon: Shield, title: "Personal Injury", description: "When an accident affects your health and livelihood, you deserve an advocate who understands the full picture — from the crash scene to the settlement table.", href: "/personal-injury"}, {icon: Globe, title: "Immigration", description: "Navigating the immigration system is complex and high-stakes. We provide clear, structured guidance to help you and your family move forward with confidence.", href: "/immigration"}].map((area) => (
              <Link key={area.title} href={area.href} className="group bg-white rounded-lg p-8 border border-border hover:border-teal/30 hover:shadow-lg transition-all">
                <area.icon className="w-8 h-8 text-teal mb-4" />
